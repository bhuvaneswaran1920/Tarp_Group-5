                    ...
                    <div class="col-sm-6 col-md-6">
                      <div class="form-group">
                       <label class="form-label">Message<span class="form-required">*</span></label>
                        <textarea class="form-control" required="true" id="c_address" autocomplete="off" placeholder="Message"  name="c_address"><?php echo (isset($customerdetails)) ? $customerdetails[0]['c_address']:'' ?></textarea>
                      </div>
                    </div>
